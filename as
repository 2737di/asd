...
if Result == "FIRST_LOCK" then
    -- เตะเพื่อให้ระบบจำเครื่องตามที่พี่ต้องการ
    game.Players.LocalPlayer:Kick("\n\n🔒 [1220Hub Security]\nระบบบันทึกเครื่องพี่ลงฐานข้อมูลแล้วสัส!\n(รันรอบที่ 2 จะเข้าได้ปกติทันที)")
    return
elseif Result ~= "SUCCESS" then
    game.Players.LocalPlayer:Kick("\n\n🚫 ไม่มีสิทธิ์ VIP หรือเครื่องไม่ตรง!\n(ไปพิมพ์ !redeem ในดิสก่อน)")
    return
end

-- [[ เริ่มรันสคริปต์ Fluent ของพี่ตรงนี้ ]]
